...
from generated.ANTLRv4ParserListener import ANTLRv4ParserListener
import antlr4
...
class Listener(ANTLRv4ParserListener):
    ...
    def exitRuleAltList(self, ctx:ANTLRv4Parser.RuleAltListContext):
        pass
        #print('choices', len(ctx.labeledAlt()))


input_stream = antlr4.FileStream('Modelica.g4')
...
def to_xsd(data):
    ...
    for rule in data['rules']:
        type = etree.Element('complex_type',
